variable "subnet_type_tag_key" {
  type        = string
  default     = "subnet/type"
  description = "Key for subnet type tag to provide information about the type of subnets, e.g. `subnet/type=private` or `subnet/type=public`"
}
...
variable "nat_gateways_count" {
  default = 1
  description = "No of nat gateways to create in a VPC"
}
